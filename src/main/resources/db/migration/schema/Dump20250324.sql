...
CREATE TABLE `favorite_category` (
                                     ...
                                     PRIMARY KEY (`id`),
                                     KEY `fk_favorite_category_user_id` (`user_id`),
                                     KEY `fk_favorite_category_category_id` (`category_id`),
                                     CONSTRAINT `fk_favorite_category_user_id` FOREIGN KEY (`user_id`)
                                         REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                                     CONSTRAINT `fk_favorite_category_category_id` FOREIGN KEY (`category_id`)
